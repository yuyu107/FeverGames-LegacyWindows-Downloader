...
try {
    Write-Host "============================================================"
    Write-Host " FeverGames Legacy Windows Downloader v1.3.6"
    ...
    Write-Host "[INFO] Known frontend profiles: 1.18.42.12 layout A; 1.18.42.14 layouts A/B; 1.18.43.22 layout A; 1.18.44.2 layout A."

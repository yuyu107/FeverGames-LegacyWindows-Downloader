...
v1.3.4 新增 FeverGames `1.18.43.22 / layout A` 支持，并继续包含 v1.3.2 的 PowerShell 2.0 / 旧 CLR 验证修复以及 v1.3.3 的 Release CMD 编码 / 换行修复。
...
| 游戏 | 发烧游戏平台 | 结果 | 备注 |
|---|---|---|---|
| 《我的世界》基岩互通版 | 1.18.42.12 / 1.18.42.14 / 1.18.43.22 | ✅ 完整下载成功 | `1.18.42.14 / layout B` 与 `1.18.43.22 / layout A` 均已验证下载完成并进入游戏 |
